...
<h3>{l s='Your order on %s is complete.' sprintf=$shop_name mod='pagofacil'}</h3>
<p>
	<br />- {l s='Amount' mod='pagofacil'} : <span class="price"><strong>{$total|escape:'htmlall':'UTF-8'}</strong></span>
...
{else}
<h3>{l s='Your order on %s has not been accepted.' sprintf=$shop_name mod='pagofacil'}</h3>
<p>
	<br />- {l s='Reference' mod='pagofacil'} <span class="reference"> <strong>{$reference|escape:'html':'UTF-8'}</strong></span>
